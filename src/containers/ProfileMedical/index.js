        ...
        <Layout2 icon={<BookOutlined className='iconOfItem' />} title={'Hồ sơ viện phí'}>
            ...
            >
                ...
                >
                    ...
                    <Form.Item
                        name="ngayRaVien"
                        rules={[{ required: true, message: 'Vui lòng nhập ngày xuất viện' }]}
                    >
                        <DatePicker />
                    </Form.Item>
                    <Form.Item
                        name="baoHiem"
                        rules={[{ required: true, message: 'Vui lòng nhập số bảo hiểm' }]}
                    >
                        <Input placeholder="Số sổ bảo hiểm" />
                    </Form.Item>
                    <Form.Item
                        name="tenBenh"
                    ...
                    <Form.Item
                        name="vienPhi"
                        rules={[{ required: true, message: 'Vui lòng nhập viện phí' }]}
                    >
                        <Input placeholder="Viện phí" />
                    </Form.Item>
